...
<title>考试管理</title>
	...
	<body>
		<section class="content-header">
	      <h1>考试查看<small>查看我的考试，我发布的考试</small></h1>
	      <ol class="breadcrumb">
					...
					<div class="box">
						<div class="box-header with-border">
							...
							<div class="box-tools pull-right">
								<div class="btn-group">
									<a href="发布考试.html"><button type="button" class="btn btn-dropbox">考试安排</button></a>
								</div>
						...
						<div class="box-body" id="shuaixuan">
							<p class="s row">
								<div class="text-right col-md-1"><label>状态:</label></div>
							...
							<p class="s row">
								<div class="col-md-1 text-right"><label>年级:</label></div>
								<div class="col-md-11 text-left">
							...
							<p class="s row">
								<div class="col-md-1 text-right"><label>课程:</label></div>
								<div class="col-md-11 text-left">
									<button type="button" class="btn btn-default">全部</button>
							...
							<p class="s row">
								<div class="col-md-1 text-right"><label>章节:</label></div>
								<div class="col-md-11 text-left">
									<button type="button" class="btn btn-default">全部</button>
						...
						<div class="box-footer">
							<p class="s">
								<div id="shuaixuanshijian">
									<div class="col-md-1 text-right"><label>时间:</label></div>
									<div class="col-md-11 text-left">
										<button type="button" class="btn btn-info">全部</button>
					...
					<div class="col-xs-12">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>1629-1632_s1结业考试</td>
									<td>机试</td>
									<td>已结束</td>
									<td>98</td>
									<td>2017-03-01:13:6</td>
									<td>2017-03-01:18:6</td>
									<td>张蓉</td>
									<td>
										<a href="考试详情.html"><button type="button" class="btn btn-primary  btn-sm">查看详情</button></a>
									</td>
								</tr>
								<tr>
									<td>2</td>
									...
									<td>张蓉</td>
									<td>
										<a href="考试登记.html"><button type="button" class="btn btn-primary  btn-sm">登记成绩</button></a>
										<a href="../cl/xuanren.html"><button type="button" class="btn btn-primary  btn-sm">加入</button></a>
										<a href="../cl/xuanren.html"><button type="button" class="btn btn-primary  btn-sm">分享权限</button></a>
									</td>
								</tr>
							</tbody>
							<tfoot>
